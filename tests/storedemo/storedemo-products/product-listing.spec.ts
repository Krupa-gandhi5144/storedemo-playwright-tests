...
test.describe('Product Listing', { tag: '@ProductListing' }, () => {

  // ✅ PASS (15)
  test('Products page full load and content verification', { tag: '@ProductsPageFullLoadAndContentVerification' }, async ({ page }) => {
  ...
  test('Products page image gallery deep inspection', { tag: '@ProductsPageImageGalleryDeepInspection' }, async ({ page }) => {
  ...
  test('Products page full scroll with element checks at each level', { tag: '@ProductsPageFullScrollWithElementChecksAtEachLevel' }, async ({ page }) => {
    await page.goto('/products');
    await page.waitForLoadState('networkidle');
  ...
  test('Products page reload stability with DOM consistency', { tag: '@ProductsPageReloadStabilityWithDomConsistency' }, async ({ page }) => {
    await page.goto('/products');
  ...
  test('Products page no JS errors during full interaction', { tag: '@ProductsPageNoJsErrorsDuringFullInteraction' }, async ({ page }) => {
    const errors: string[] = [];
  ...
  test('Products page navigate to detail and back multiple times', { tag: '@ProductsPageNavigateToDetailAndBackMultipleTimes' }, async ({ page }) => {
    await page.goto('/products');
    await page.waitForLoadState('networkidle');
    for (let i = 0; i < 3; i++) {
      const productCard = page.locator('[class*="product"], [class*="card"], a[href*="product"]').first();
  ...
  test('Products page link and button integrity check', { tag: '@ProductsPageLinkAndButtonIntegrityCheck' }, async ({ page }) => {
    await page.goto('/products');
    await page.waitForLoadState('networkidle');
  ...
  test('Products page multi-cycle home to products navigation', { tag: '@ProductsPageMulticycleHomeToProductsNavigation' }, async ({ page }) => {
  ...
  test('Products page performance multi-load validation', { tag: '@ProductsPagePerformanceMultiloadValidation' }, async ({ page }) => {
  ...
  test('Products page CSS and layout structure verification', { tag: '@ProductsPageCssAndLayoutStructureVerification' }, async ({ page }) => {
    await page.goto('/products');
    await page.waitForLoadState('networkidle');
  ...
  test('Products page keyboard navigation through product cards', { tag: '@ProductsPageKeyboardNavigationThroughProductCards' }, async ({ page }) => {
    await page.goto('/products');
    await page.waitForLoadState('domcontentloaded');
    await page.waitForTimeout(2000);
    for (let i = 0; i < 10; i++) {
  ...
  test('Products page document metadata and structure', { tag: '@ProductsPageDocumentMetadataAndStructure' }, async ({ page }) => {
    const response = await page.goto('/products');
    expect(response?.status()).toBe(200);
    await page.waitForLoadState('networkidle');
    const title = await page.title();
  ...
  test('Products page product card interaction and detail preview', { tag: '@ProductsPageProductCardInteractionAndDetailPreview' }, async ({ page }) => {
    await page.goto('/products');
    await page.waitForLoadState('networkidle');
  ...
  test('Products page browser back forward deep navigation', { tag: '@ProductsPageBrowserBackForwardDeepNavigation' }, async ({ page }) => {
    await page.goto('/');
    await expect(page).toHaveURL(/storedemo/);
    await page.waitForTimeout(2000);
    await page.goto('/products');
  ...
  // ❌ FAIL (7)
  test('Products page should show pagination with 20 pages', { tag: '@ProductsPageShouldShowPaginationWith20Pages' }, async ({ page }) => {
    await page.goto('/products');
    await page.waitForTimeout(2000);
    await page.evaluate(() => window.scrollTo(0, document.body.scrollHeight));
    await page.waitForTimeout(2000);
  ...
  test('Verify Out of Stock badge on first product', { tag: '@VerifyOutOfStockBadgeOnFirstProduct' }, async ({ page }) => {
    await page.goto('/products');
    await page.waitForTimeout(2000);
  ...
  test('Products sorted by price descending by default', { tag: '@ProductsSortedByPriceDescendingByDefault' }, async ({ page }) => {
    await page.goto('/products');
    await page.waitForTimeout(2000);
  ...
  test('Products page should show filter sidebar', { tag: '@ProductsPageShouldShowFilterSidebar' }, async ({ page }) => {
    await page.goto('/products');
    await page.waitForTimeout(2000);
  ...
  test('Products page should display product ratings', { tag: '@ProductsPageShouldDisplayProductRatings' }, async ({ page }) => {
    await page.goto('/products');
    await page.waitForTimeout(2000);
  ...
  test('Products page should show grid/list view toggle', { tag: '@ProductsPageShouldShowGridlistViewToggle' }, async ({ page }) => {
    await page.goto('/products');
    await page.waitForTimeout(2000);
  ...
  test('Products page should display total product count label', { tag: '@ProductsPageShouldDisplayTotalProductCountLabel' }, async ({ page }) => {
    await page.goto('/products');
    await page.waitForTimeout(2000);
  ...
  // 🔄 FLAKY (3)
  test('Flaky - Product count validation', { tag: '@FlakyProductCountValidation' }, async ({ page }) => {
  ...
  test('Flaky - Product image lazy loading', { tag: '@FlakyProductImageLazyLoading' }, async ({ page }) => {
    if (test.info().retry === 0) { expect(true).toBe(false); }
    await page.goto('/products');
    await page.waitForTimeout(3000);
  ...
  test('Flaky - Product card hover state', { tag: '@FlakyProductCardHoverState' }, async ({ page }) => {
    if (test.info().retry === 0) { expect(true).toBe(false); }
    await page.goto('/products');
    await page.waitForTimeout(3000);
  ...
  // ⏭️ SKIP (2)
  test.skip('Infinite scroll loads more products', { tag: '@InfiniteScrollLoadsMoreProducts' }, async ({ page }) => {
    await page.goto('/products');
    await page.evaluate(() => window.scrollTo(0, document.body.scrollHeight));
  });

  test.skip('Product listing drag and drop reorder', { tag: '@ProductListingDragAndDropReorder' }, async ({ page }) => {
    await page.goto('/products');
  });
